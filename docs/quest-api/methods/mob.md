=== "Perl (571)"
    ...
    $mob->ChangeSize(float in_size, bool no_restriction);
    $mob->Charmed();
    ...
    $mob->SendIllusion(uint16 race, uint8 gender, uint8 texture);
    $mob->SendIllusion(uint16 race, uint8 gender, uint8 texture, uint8 helmtexture, uint8 face, uint8 hairstyle, uint8 haircolor, uint8 beard, uint8 beardcolor, uint32 drakkin_heritage, uint32 drakkin_tattoo, uint32 drakkin_details, float size);
    $mob->SendIllusion(uint16 race, uint8 gender, uint8 texture, uint8 helmtexture, uint8 face, uint8 hairstyle, uint8 haircolor, uint8 beard, uint8 beardcolor, uint32 drakkin_heritage, uint32 drakkin_tattoo, uint32 drakkin_details, float size, Client* target);
    $mob->SendIllusion(uint16 race, uint8 gender, uint8 texture, uint8 helmtexture, uint8 face, uint8 hairstyle, uint8 haircolor);
    $mob->SendIllusion(uint16 race, uint8 gender, uint8 texture, uint8 helmtexture, uint8 face, uint8 hairstyle, uint8 haircolor, uint8 beard, uint8 beardcolor, uint32 drakkin_heritage, uint32 drakkin_tattoo, uint32 drakkin_details);
    $mob->SendIllusion(uint16 race, uint8 gender, uint8 texture, uint8 helmtexture, uint8 face, uint8 hairstyle, uint8 haircolor, uint8 beard, uint8 beardcolor);
    $mob->SendIllusion(uint16 race, uint8 gender, uint8 texture, uint8 helmtexture, uint8 face);
    $mob->SendIllusion(uint16 race);
    $mob->SendIllusion(uint16 race, uint8 gender, uint8 texture, uint8 helmtexture, uint8 face, uint8 hairstyle, uint8 haircolor, uint8 beard, uint8 beardcolor, uint32 drakkin_heritage, uint32 drakkin_tattoo);
    $mob->SendIllusion(uint16 race, uint8 gender, uint8 texture, uint8 helmtexture);
    $mob->SendIllusion(uint16 race, uint8 gender, uint8 texture, uint8 helmtexture, uint8 face, uint8 hairstyle, uint8 haircolor, uint8 beard);
    $mob->SendIllusion(uint16 race, uint8 gender);
    $mob->SendIllusion(uint16 race, uint8 gender, uint8 texture, uint8 helmtexture, uint8 face, uint8 hairstyle);
    $mob->SendIllusion(uint16 race, uint8 gender, uint8 texture, uint8 helmtexture, uint8 face, uint8 hairstyle, uint8 haircolor, uint8 beard, uint8 beardcolor, uint32 drakkin_heritage);
    ...
    $mob->WearChange(uint8 material_slot, uint16 texture);
    $mob->WearChange(uint8 material_slot, uint16 texture, uint32 color);
    $mob->WearChange(uint8 material_slot, uint16 texture, uint32 color, uint32 hero_forge_model);
    $mob->WipeHateList();
    ```
=== "Lua (509)"
    ...
    mob:WearChange(uint8 material_slot, uint16 texture, uint32 color);
    mob:WearChange(uint8 material_slot, uint16 texture);
    mob:WearChange(uint8 material_slot, uint16 texture, uint32 color, uint32 heros_forge_model);
    mob:WipeHateList();
    ```
