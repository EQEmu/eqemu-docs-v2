=== "Lua (574)"
    ...
    eq.get_instance_ids(State* L, string zone_name);
    eq.get_instance_ids_by_char_id(State* L, string zone_name, uint32 character_id);
    ...
    eq.set_aa_exp_modifier_by_char_id(uint32 character_id, uint32 zone_id, double aa_modifier, int16 instance_version);
    ...
    eq.set_exp_modifier_by_char_id(uint32 character_id, uint32 zone_id, double exp_modifier, int16 instance_version);
