...
DMSPRITEDEF2
	...
	NUMVERTICES 1 // Optional
	XYZ 0.0000000e+000 0.0000000e+000 0.0000000e+000

	NUMUVS 1 // Optional
	UV 0.0000000e+000 0.0000000e+000

	NUMVERTEXNORMALS 1 // Optional
	XYZ 0.0000000e+000 0.0000000e+000 0.0000000e+000

	SKINASSIGNMENTGROUPS 2 0, 1, 2, 3 // Optional
	...
	NUMMESHOPS 3 // Optional
	MESHOP_VA 22
	MESHOP_SW 184 3 36
	MESHOP_EL 1.0000000e+000

	FACEMATERIALGROUPS 2 0, 1, 2, 3 // Optional

	VERTEXMATERIALGROUPS 2 0, 1, 2, 3 // Optional
...
ACTORDEF
	...
	CURRENTACTION 0 // Optional
	LOCATION 0.000000 0.000000 0.000000 // Optional
	NUMACTIONS 1
	ACTION
		NUMLEVELSOFDETAIL 1
		LEVELOFDETAIL
			3DSPRITE "BIX_3DSPRITE" // Optional
			HIERARCHICALSPRITE "BIX_HS_DEF" // Optional
