...
A CPI world definition. This wraps definitions that are scoped as a world. These are typically found in .wld files.

Referred to by: [??](#worlddefinition)

WLD opcodes impacted: 0x01 (CpiWorld)
...
A 3D sprite definition. This is a collection of properties that defines a 3D sprite. These are typically found in .spk files.
...
A world tree. This is a collection of properties that defines a world tree. These are typically found in .spk files.
...
A region. This is a collection of properties that defines a region. These are typically found in .spk files.
