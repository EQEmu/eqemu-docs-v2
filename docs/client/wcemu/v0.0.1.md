...
- SPRITE: name of a sprite reference
...
- RGBDEFORMATIONTRACKINST: start of instance
- TAG: unique tag name for the track instance
- DEFINITION: name of the track definition
- FLAGS: flags for the track instance
- ENDRGBDEFORMATIONTRACKINST: end of instance
